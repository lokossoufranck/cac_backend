...
<div class="wrapper" id="app">
    ...
    <div class="sidebar">
      <!-- Sidebar user panel (optional) -->
        ...
        @if (Route::currentRouteName() =='app')
             <!-- Sidebar Menu  du module sélectionné-->
             @include('layouts.sidebar-menu-app')
              <!-- Sidebar Menu  du module sélectionné-->
        @else
            <!-- Sidebar Menu -->
  ...
  <footer class="main-footer">
    ...
    {{-- Default to the left --}}
    <strong>Copyright &copy; 2022 <a target="_blank" href="https://amehouga.com/">CAC</a>.</strong> All rights reserved.
  </footer>
</div>
{{-- ./wrapper --}}
